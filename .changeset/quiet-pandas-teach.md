...
Rewrite the README as consumer documentation, and correct an example that receives nothing.
...
resource *kind* channel, while events are published to the *action* channel
